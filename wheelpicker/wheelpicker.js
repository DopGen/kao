...
! function(t, e) {
  ...
  return function(t) {
    ...
    s.prototype = {
      ...
      _createDOM: function() {
        this.container = document.createElement("div"), this.container.className = "wheelpicker", this.origEl && (this.container.id = "wheelpicker-" + (this.origEl.name || this.origEl.id)), this.container.innerHTML = "<div class='wheelpicker-backdrop'></div><div class='wheelpicker-panel'><div class='wheelpicker-actions'><button type='button' class='btn-cancel'>Close</button><h4 class='wheelpicker-title'></h4></div><div class='wheelpicker-main'><div class='wheelpicker-wheels'></div><div class='wheelpicker-mask wheelpicker-mask-top'></div><div class='wheelpicker-mask wheelpicker-mask-current'></div><div class='wheelpicker-mask wheelpicker-mask-btm'></div></div></div>", this.wheelsContainer = this.container.querySelector(".wheelpicker-wheels"), this.options.onRender && this.options.onRender.call(this, this.container), document.body.appendChild(this.container)
      },
      _bindEvents: function() {
        this._onFocus = function(t) {
          t.target.blur(), this.show()
        }.bind(this), this.control && this.control.addEventListener("focus", this._onFocus), this.options.hideOnBackdrop && this.container.querySelector(".wheelpicker-backdrop").addEventListener("click", this._cancel.bind(this)), this.container.querySelector(".wheelpicker-actions .btn-cancel").addEventListener("click", this._cancel.bind(this)), this.container.querySelector(".wheelpicker-backdrop").addEventListener(this.transitionendName, this._backdropTransEnd.bind(this))
      },
